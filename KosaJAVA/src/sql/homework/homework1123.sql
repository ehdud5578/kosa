...
--- 그룹함수를 사용한 경우 select 절에 올 수 있는 컬럼은 group by절에 있는
-- 컬럼만 올수 있다.

--- 직원의 급여가 6000이상인 사원들의 부서별 평균을 구하고 부서별 평균이
-- 7000이상인 부서만 출력하시오. 부서를 내림차순

--- 직무가 'REP'를 포함하고 있지 않은 직원들의 직무별 급여의 합계가 13000이상은
...
------2.사원테이블에서 사원번호, 부서번호, 이름 급여를 출력하는데 입사일이 02/
-- 06/
-- 07인 사원들만 출력하시오.
...
-- 16년부터 08/
-- 01/
-- 29년사이의 입사한 사람을 부서와 사번 그리고 이름을 출력하는데 입사일이 늦은 사원 부터 출력하시오.
