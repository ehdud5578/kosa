...
values (100, 'doyoung', 'park', 'ehdud5578', '010-1234-1234', '1996-06-17', null, null, 1000, null, 10);
...
insert into tb1(col1)
values ('박도영');
insert into tb1(col2)
values ('abc');
insert into tb1(col2)
values ('박도영');
insert into tb1(col3)
values ('abc');
insert into tb1(col3)
values ('박도영');
...
select *
from user_tab_cols -- kosa - table - cols
...
insert into tb9
values (1, 'a', '1234', 'firstname');
insert into tb9
values (2, null, '1235', 'firstname');
insert into tb9
values (3, null, '123', 'firstname');
insert into tb9
values (3, '', '1235', 'firstname');
insert into tb9
values (4, '', '', 'firstname');
select *
from tb9;
